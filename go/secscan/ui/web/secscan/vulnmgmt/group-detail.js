...
window.SecScanGroupDetail = (function() {
    ...
    const SCAN_STATUS = Layer8EnumFactory.create([
        ...
        // Trivy hit a registry auth error (denied/unauthorized): the
        // credentials mounted on the scanner pod don't cover this image's
        // registry host. Same "warning" style as Missing -- it's a
        // deployment fix (encripted/apply-registry-credentials.sh), not
        // the dead end Failed is.
